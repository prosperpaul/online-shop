  ...
  if(cartItems.length === 0)
    return <div className='container mx-auto px-4 py-8'>
      <div className='text-center'>
        ...
        <Link to='/' className='inline-block bg-zinc-200 px-6 py-2 round-lg hover:bg-zinc-300'>Continue Shopping</Link>
      </div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
            ...
            <div key={item.id} className='flex items-center gap-4 py-4 border-b'>
              ...
              <div className='flex-1'>
                ...
                <div className='flex items-center gap-2 mt-2'>
                  ...
                  <button className='p-1 rounded-full hover:bg-gray-100' onClick={()=>dispatch(
                    updateQuantity(
                      {
                        id:item.id,
        ...
        <div className='lg:col-span-1'>
          ...
          <div className='flex justify-between'>
           ...
           <button className='w-full bg-zinc-200 px-6 rounded-lg hover:bg-zinc-300 py-3'>Proceed to Checkout</button>
        </div>
        </div>
